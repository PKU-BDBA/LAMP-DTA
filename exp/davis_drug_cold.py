...
class ColdExp(object):
    ...
    def run(self):
        ...
        if self.args.test:
            ...
            model_module.setup_fold_index(0)
            data_module.setup_cold_way('d', is_test=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', default=160, type=int) # XXX
    ...
    args.log_dir = f'{args.model}_{args.dataset}_drug_cold_logs'
