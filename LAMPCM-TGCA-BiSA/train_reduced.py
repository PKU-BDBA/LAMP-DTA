...
def main():
    ...
    train_eval_reduced(model, optimizer,scheduler, train_loader, val_loader, test_loader, args.epochs, args.dataset, gpu=args.gpu, fold=args.fold, test_cutoff=args.cutoff)
